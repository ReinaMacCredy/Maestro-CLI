...
Plan complete and saved to `.maestro/tracks/{track_id}/plan.md`.

Two execution options:
1. Subagent-Driven (this session) - Dispatch fresh subagent per task, review between tasks, fast iteration
2. Parallel Session (separate) - Open new session with maestro:implement, batch execution with checkpoints
...
- **REQUIRED SUB-SKILL:** New session uses maestro:implement
